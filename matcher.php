...
if (isset($_POST['analyze'])) {
    ...
    if ($rasa == 'asam') $pesan_ai = "Anda suka karakter <strong>Fruity & Bright</strong>. Saran: Sumatra (Gayo) atau Bali.";
    elseif ($rasa == 'pahit') $pesan_ai = "Anda suka kopi <strong>Bold & Strong</strong>. Saran: Sulawesi (Toraja) atau Jawa.";
    else $pesan_ai = "Anda suka keseimbangan. Saran: Lintong atau Flores Bajawa.";
...
<body style="background: #fdfbf7;">
    ...
    <main class="container" style="max-width: 800px; padding: 3rem 1rem;">
        ...
        <?php else : ?>
        <div style="background: #dcfce7; padding: 2rem; border-radius: 12px; border: 1px solid #86efac; text-align: center; margin-bottom: 3rem;">
